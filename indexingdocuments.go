...
func (s *IndexingDocuments) DebugEvents(ctx context.Context, datasource string, debugDocumentLifecycleRequest components.DebugDocumentLifecycleRequest, opts ...operations.Option) (*operations.PostAPIIndexV1DebugDatasourceDocumentEventsResponse, error) {
	request := operations.PostAPIIndexV1DebugDatasourceDocumentEventsRequest{
		Datasource:                    datasource,
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/api/index/v1/debug/{datasource}/document/events", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "DebugDocumentLifecycleRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.PostAPIIndexV1DebugDatasourceDocumentEventsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.DebugDocumentLifecycleResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.DebugDocumentLifecycleResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err

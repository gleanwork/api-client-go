...
func (s *Chat) Create(ctx context.Context, request operations.PlatformChatCreateRequest, opts ...operations.Option) (*operations.PlatformChatCreateResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/chat")
	if err != nil {
	...
	res := &operations.PlatformChatCreateResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.PlatformChatCompletedResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PlatformChatCompletedResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Chat) CreateStream(ctx context.Context, request operations.PlatformChatCreateStreamRequest, opts ...operations.Option) (*operations.PlatformChatCreateStreamResponse, error) {
	...
	res := &operations.PlatformChatCreateStreamResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `text/event-stream`):
			out := stream.NewEventStream(ctx, httpRes.Body, func(se []byte) (components.PlatformChatStreamEventServerSentEvent, error) {
				var e components.PlatformChatStreamEventServerSentEvent

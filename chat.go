...
func (s *Chat) Ask(ctx context.Context, xGleanActAs *string, xGleanAuthType *string, askRequest *components.AskRequest, opts ...operations.Option) (*operations.AskResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/rest/api/v1/ask")
	if err != nil {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, true, "AskRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.AskResponse

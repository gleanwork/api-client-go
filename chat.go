...
// GetChatFile - Download a chat file
...
func (s *Chat) GetChatFile(ctx context.Context, fileID string, preview *bool, opts ...operations.Option) (*operations.GetChatFileResponse, error) {

...
func (s *Collections) EditItem(ctx context.Context, request components.EditCollectionItemRequest, opts ...operations.Option) (*operations.EditcollectionitemResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *Collections) Get(ctx context.Context, request components.GetCollectionRequest, opts ...operations.Option) (*operations.GetcollectionResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,

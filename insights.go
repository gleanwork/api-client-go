...
func newInsights(rootSDK *Glean, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Insights {
	return &Insights{
		rootSDK:          rootSDK,
...
func (s *Insights) Retrieve(ctx context.Context, insightsRequest components.InsightsRequest, locale *string, opts ...operations.Option) (*operations.InsightsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/rest/api/v1/insights")
	if err != nil {
	...
	res := &operations.InsightsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.InsightsResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.InsightsResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err

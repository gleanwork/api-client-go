...
func newIndexingShortcuts(rootSDK *Glean, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *IndexingShortcuts {
	return &IndexingShortcuts{
		rootSDK:          rootSDK,
...
// BulkIndex - Bulk index external shortcuts
...
func (s *IndexingShortcuts) BulkIndex(ctx context.Context, request components.BulkIndexShortcutsRequest, opts ...operations.Option) (*operations.PostAPIIndexV1BulkindexshortcutsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/api/index/v1/bulkindexshortcuts")
	if err != nil {
	...
	res := &operations.PostAPIIndexV1BulkindexshortcutsResponse{

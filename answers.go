...
func (s *Answers) Edit(ctx context.Context, request components.EditAnswerRequest, opts ...operations.Option) (*operations.EditanswerResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *Answers) Get(ctx context.Context, request components.GetAnswerRequest, opts ...operations.Option) (*operations.GetanswerResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,

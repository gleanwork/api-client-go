...
// Generated from OpenAPI doc version 0.9.0 and generator version 2.915.1
...
func New(opts ...SDKOption) *Glean {
	sdk := &Glean{
		SDKVersion: "0.13.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.13.1 2.915.1 0.9.0 github.com/gleanwork/api-client-go",

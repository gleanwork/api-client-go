...
// Generated from OpenAPI doc version 0.9.0 and generator version 2.933.0
...
func New(opts ...SDKOption) *Glean {
	sdk := &Glean{
		SDKVersion: "0.14.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.14.2 2.933.0 0.9.0 github.com/gleanwork/api-client-go",

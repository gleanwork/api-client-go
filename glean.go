...
// Generated from OpenAPI doc version 0.9.0 and generator version 2.865.2
...
func New(opts ...SDKOption) *Glean {
	sdk := &Glean{
		SDKVersion: "0.11.32",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 0.11.32 2.865.2 0.9.0 github.com/gleanwork/api-client-go",

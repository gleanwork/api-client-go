...
func (s *Search) SuggestPeople(ctx context.Context, peopleSuggestRequest components.PeopleSuggestRequest, xScioActas *string, xGleanAuthType *string, opts ...operations.Option) (*operations.PeoplesuggestResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/rest/api/v1/peoplesuggest")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "PeopleSuggestRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	res := &operations.PeoplesuggestResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.PeopleSuggestResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.PeopleSuggestResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Search) SuggestPeopleAdmin(ctx context.Context, peopleSuggestRequest components.PeopleSuggestRequest, xScioActas *string, xGleanAuthType *string, opts ...operations.Option) (*operations.PeoplesuggestadminResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/rest/api/v1/peoplesuggestadmin")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.PeoplesuggestadminResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},

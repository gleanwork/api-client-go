...
func (p *PlatformFilterFieldInfo) GetField() string {
	if p == nil {
		return ""
	}
	return p.Field
...
func (p *PlatformFilterFieldInfo) GetType() string {
	if p == nil {
		return ""
	}
	return p.Type
...
func (p *PlatformFilterFieldInfo) GetOperators() []PlatformFilterOperator {
	if p == nil {
...
func (p *PlatformFilterFieldInfo) GetValues() []string {
	if p == nil {
		return nil
	}
	return p.Values

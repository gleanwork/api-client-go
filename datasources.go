...
func newDatasources(rootSDK *Glean, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Datasources {
	return &Datasources{
		rootSDK:          rootSDK,
...
func (s *Datasources) GetDatasourceCredentialStatus(ctx context.Context, datasourceInstanceID string, opts ...operations.Option) (*operations.GetDatasourceCredentialStatusResponse, error) {
...
func (s *Datasources) RotateDatasourceCredentials(ctx context.Context, datasourceInstanceID string, rotateDatasourceCredentialsRequest components.RotateDatasourceCredentialsRequest, opts ...operations.Option) (*operations.RotateDatasourceCredentialsResponse, error) {

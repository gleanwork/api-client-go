...
value := components.IssueAgentCanvasFailed
```
...
| Name                                | Value                               |
| ----------------------------------- | ----------------------------------- |
| `IssueAgentCanvasFailed`            | AGENT_CANVAS_FAILED                 |
| `IssueAgentClarifyingQuestions`     | AGENT_CLARIFYING_QUESTIONS          |
| `IssueAgentIntermediateStepsFailed` | AGENT_INTERMEDIATE_STEPS_FAILED     |
| `IssueAgentToolCallFailed`          | AGENT_TOOL_CALL_FAILED              |

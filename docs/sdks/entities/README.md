...
func main() {
    ...
    res, err := s.Client.Entities.GetTeams(ctx, components.TeamsRequest{
        Ids: []string{
            "abc123",
        },
    }, nil, nil)
...
**[*operations.TeamsResponse](../../models/operations/teamsresponse.md), error**

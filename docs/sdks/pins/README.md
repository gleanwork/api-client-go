...
**[*operations.EditpinResponse](../../models/operations/editpinresponse.md), error**
...
func main() {
    ...
    res, err := s.Client.Pins.Get(ctx, components.GetPinRequest{})
    if err != nil {
        log.Fatal(err)
    }
...
**[*operations.ListpinsResponse](../../models/operations/listpinsresponse.md), error**
...
**[*operations.PinResponse](../../models/operations/pinresponse.md), error**
...
**[*operations.UnpinResponse](../../models/operations/unpinresponse.md), error**

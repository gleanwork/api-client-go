...
func newClientChat(sdkConfig sdkConfiguration) *ClientChat {
	return &ClientChat{
...
func (s *ClientChat) Start(ctx context.Context, chatRequest components.ChatRequest, timezoneOffset *int64, opts ...operations.Option) (*operations.ChatResponse, error) {
...
func (s *ClientChat) DeleteAll(ctx context.Context, timezoneOffset *int64, opts ...operations.Option) (*operations.DeleteallchatsResponse, error) {
...
func (s *ClientChat) Delete(ctx context.Context, deleteChatsRequest components.DeleteChatsRequest, timezoneOffset *int64, opts ...operations.Option) (*operations.DeletechatsResponse, error) {
...
func (s *ClientChat) Get(ctx context.Context, getChatRequest components.GetChatRequest, timezoneOffset *int64, opts ...operations.Option) (*operations.GetchatResponse, error) {
...
func (s *ClientChat) List(ctx context.Context, timezoneOffset *int64, opts ...operations.Option) (*operations.ListchatsResponse, error) {
...
func (s *ClientChat) GetApplication(ctx context.Context, getChatApplicationRequest components.GetChatApplicationRequest, timezoneOffset *int64, opts ...operations.Option) (*operations.GetchatapplicationResponse, error) {
...
func (s *ClientChat) UploadFiles(ctx context.Context, uploadChatFilesRequest components.UploadChatFilesRequest, timezoneOffset *int64, opts ...operations.Option) (*operations.UploadchatfilesResponse, error) {
...
func (s *ClientChat) GetFiles(ctx context.Context, getChatFilesRequest components.GetChatFilesRequest, timezoneOffset *int64, opts ...operations.Option) (*operations.GetchatfilesResponse, error) {
...
func (s *ClientChat) DeleteFiles(ctx context.Context, deleteChatFilesRequest components.DeleteChatFilesRequest, timezoneOffset *int64, opts ...operations.Option) (*operations.DeletechatfilesResponse, error) {

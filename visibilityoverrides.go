...
func newVisibilityoverrides(rootSDK *Glean, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Visibilityoverrides {
...
func (s *Visibilityoverrides) List(ctx context.Context, docIds []string, opts ...operations.Option) (*operations.GetdocvisibilityResponse, error) {
	request := operations.GetdocvisibilityRequest{
		DocIds: docIds,
	}
	...
	opURL, err := url.JoinPath(baseURL, "/rest/api/v1/governance/documents/visibilityoverrides")
	if err != nil {
	...
	res := &operations.GetdocvisibilityResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json; charset=UTF-8`):
			...
			var out components.GetDocumentVisibilityOverridesResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.GetDocumentVisibilityOverridesResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Visibilityoverrides) Create(ctx context.Context, request components.UpdateDocumentVisibilityOverridesRequest, opts ...operations.Option) (*operations.SetdocvisibilityResponse, error) {
	...
	res := &operations.SetdocvisibilityResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json; charset=UTF-8`):
			...
			var out components.UpdateDocumentVisibilityOverridesResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.UpdateDocumentVisibilityOverridesResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err

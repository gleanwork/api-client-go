...
func newClientAuthentication(sdkConfig sdkConfiguration) *ClientAuthentication {
...
func (s *ClientAuthentication) CreateAnonymousToken(ctx context.Context, opts ...operations.Option) (*operations.CreateanonymoustokenResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/rest/api/v1/createanonymoustoken")
	if err != nil {
	...
	if retryConfig != nil {
		...
		if err != nil || httpRes == nil {
			...
			_, err = s.sdkConfiguration.Hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
			return nil, err
		} else if utils.MatchStatusCodes([]string{"400", "403", "429", "4XX", "5XX"}, httpRes.StatusCode) {
	...
	res := &operations.CreateanonymoustokenResponse{

...
func newPins(sdkConfig sdkConfiguration) *Pins {
	return &Pins{
...
func (s *Pins) Edit(ctx context.Context, request components.EditPinRequest, opts ...operations.Option) (*operations.EditpinResponse, error) {
...
func (s *Pins) Get(ctx context.Context, request components.GetPinRequest, opts ...operations.Option) (*operations.GetpinResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,

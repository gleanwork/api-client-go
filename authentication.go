...
func newAuthentication(rootSDK *Glean, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Authentication {
...
func (s *Authentication) Checkdatasourceauth(ctx context.Context, opts ...operations.Option) (*operations.CheckdatasourceauthResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/rest/api/v1/checkdatasourceauth")
	if err != nil {
	...
	res := &operations.CheckdatasourceauthResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CheckDatasourceAuthResponse
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.CheckDatasourceAuthResponse = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err

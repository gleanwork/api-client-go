...
func (s *Messages) Get(ctx context.Context, request components.MessagesRequest, opts ...operations.Option) (*operations.MessagesResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/rest/api/v1/messages")
	if err != nil {
	...
	res := &operations.MessagesResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.MessagesResponse

...
func newClientTools(rootSDK *Glean, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *ClientTools {
	return &ClientTools{
		rootSDK:          rootSDK,
...
func (s *ClientTools) List(ctx context.Context, toolNames []string, opts ...operations.Option) (*operations.GetRestAPIV1ToolsListResponse, error) {
...
func (s *ClientTools) Run(ctx context.Context, request components.ToolsCallRequest, opts ...operations.Option) (*operations.PostRestAPIV1ToolsCallResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,

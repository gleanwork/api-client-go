...
func (s *Calendar) GetEvents(ctx context.Context, getEventsRequest components.GetEventsRequest, xScioActas *string, xGleanAuthType *string, opts ...operations.Option) (*operations.GeteventsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/rest/api/v1/getevents")
	if err != nil {
	...
	bodyReader, reqContentType, err := utils.SerializeRequestBody(ctx, request, false, false, "GetEventsRequest", "json", `request:"mediaType=application/json"`)
	if err != nil {
		return nil, err
	}
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.GetEventsResponse
